...
questionAddRequest: QuestionAddRequest,
    ...
    public static addQuestionListUsingPost(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/questionList/add/byself',
            body: questionAddRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
    ...
    public static addQuestionListAIUsingPost(
        questionAddRequest: QuestionAddRequest,
    ): CancelablePromise<BaseResponse_long_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/questionList/add/ai',
            body: questionAddRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
...
id?: number,
    ...
    public static newComment(
        comment:any,questionId?: number,
    ): CancelablePromise<BaseResponse_QuestionVO_> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/comment/add/questioncomment',
            query: {
                'comment': comment,
...
questionQueryRequest: QuestionQueryRequest,
    ...
    public static listQuestionListQuestionByPageUsingPost(
        questionQueryRequest: QuestionQueryRequest,
    ): CancelablePromise<BaseResponse_Page_Question_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/questionList/list/page/question',
            body: questionQueryRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
